...
/**
 * Every major section begins with a firm rule. This replaces the previous
 * decorative divider and makes page hierarchy unambiguous while remaining calm.
 */
...
/** A functional section boundary, not a decorative diagram. */
export function TimingDivider({ className = "" }: { className?: string }) {
  return (
    <div className={className} aria-hidden="true">
      <div className="mx-auto h-px w-full max-w-[96rem] bg-carbon-700" />
    </div>
  );
}

/** Kept as a layout hook; the minimalist system intentionally has no backdrop. */
